# ==============================================================================
# Script: OMAA_Score_Construction.R
# Purpose: Construct the Oral Microbiome Age (OMAA) Score using Random Forest.
...
write.xlsx(discovery_results, "results/OMAA_Discovery_CV_Results.xlsx")
...
write.xlsx(val1_results, "results/OMAA_Validation_1_Results.xlsx")
...
write.xlsx(ext2_results, "results/OMAA_External_Validation_2_Results.xlsx")
